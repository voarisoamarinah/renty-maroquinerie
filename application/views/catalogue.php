...
<head>
    ...
    <title>Renty | Détails de l'article</title>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="vogue" id="vogue">
            <h1 class="titre"><?php //echo $article['nom_article']; ?></h1>
            <form class="vogue-box" method="post" style="width: 500px;">
                <img src="../media/article/poster/<?php echo $article['article_photo']; ?>" style="width: 100%;height:100%;object-fit:cover;">
                <div class="icons">
            ...
            <b>Date de création : <?php echo $article['article_date_crea']; ?></b>
            <br>
            <br>
            <?php echo $article['description_article']; ?>
            <br>
            <br>
            <?php echo $article['prix']; ?> MGA
            </p>
            <h4></h4>
        </div>

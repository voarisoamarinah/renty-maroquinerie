...
<head>
    ...
    <title>Renty | Administrateur - Gestionnaire des retours utilisateur</title>
</head>
<body>
    <div class="container">
        <!-- <header> -->
        ...
        <main>
            <div class="big-container">
                ...
                <div class="small-container">
                    <div class="box">
                        <div class="info">
                            <img src="../media/utilisateur/<?php echo $feedback['photo']; ?>">
                            <label>
                                <b><?php echo $feedback['nom'].' '.$feedback['prenom']; ?> <?php echo $feedback['email']; ?></b>
                                <p><?php echo $feedback['commentaire']; ?></p>
                                <h6><?php echo $feedback['feedback_date_crea']; ?></h6>
                            </label>
                        </div>
                    </div>
                </div>

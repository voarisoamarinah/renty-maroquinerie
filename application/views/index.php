...
<body>
    ...
    <div class="container">
        ...
        <div class="nouveautes">
            <div class="box" style="background-image: '../media/article/poster/<?php echo $article['photo']; ?>';">
                <h1><?php echo $article['nom_article'] ;?></h1>
                <p><?php echo $article['description_article'] ;?></p>
                <a href="<?php echo base_url('Frontoffice/catalogue?id_article='.$article['id_article']); ?>">Détails <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>

        <div class="vogue" id="vogue">
            <h1 class="titre">Nos coups de coeurs</h1>
            <?php 
        ...
        <h1 class="titre">Nos recommandations</h1>
        <div class="recommandations">
            ...
            <form class="box" method="post">
                <div style="width: 170px;height: 180px;">
                    <img src="../media/article/<?php echo $article['article_photo']; ?>" style="width: 100%;height:100%;object-fit:cover;">
                </div>
                <center>
                    <a href="<?php echo base_url('Frontoffice/catalogue?id_article='.$article['id_article']); ?>"><button name="add-btn">Détails</button></a>
                </center>
            </form>
            <?php  
            }
            ?>
            <div style="width: 170px;height: 180px; display:flex; justify-content:center; align-items:center;">
            <br>    
            <a href="<?php echo base_url('Frontoffice/articles'); ?>" id="voirplus"><b>Voir plus</b> <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
